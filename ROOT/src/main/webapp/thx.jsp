...
<head>
	<title>Open Balloon Map | Danke für den Eintrag</title>
...
<body>
	<div class="content">
		...
		<form class="info">
			Herzlichen Dank<br />
			für Ihren Eintrag!<br /><br />
			Weitere Informationen<br />
			zum Projekt und alle<br />
			existierenden Events<br />
			finden Sie unter<br /><br />
			<a class="box" href="http://openballoonmap.org">www.openballoonmap.org</a><br /><br />
